...
// getEmailFromJSON returns the Account email address
...
// getUserIDFromJSON returns the Account ID, if available
...
// GetUserDetails returns map with Account data (Email, ID)
